...
const KRAAPHT_CONFIG = {
  ...
  about: {
    ...
    certifications_note:   " Kraapht Bags Ltd is a registered company in Ghana. We do not currently hold additional food-safety or packaging standards-body certifications (e.g. Ghana Standards Authority, FDA Ghana).",
  },
  // =================================================================
  //  IMAGES
